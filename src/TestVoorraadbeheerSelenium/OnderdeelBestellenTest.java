...
public class OnderdeelBestellenTest {
  ...
  public void testOnderdeelBestellen() throws Exception {
    ...
    driver.findElement(By.name("voorraadNaam")).sendKeys("Wieldop");
    Thread.sleep(2000L);
    driver.findElement(By.name("voorraadMin")).clear();
    driver.findElement(By.name("voorraadMin")).sendKeys("5");
    Thread.sleep(2000L);
    driver.findElement(By.name("voorraad")).clear();
    driver.findElement(By.name("voorraad")).sendKeys("10");
    Thread.sleep(2000L);
