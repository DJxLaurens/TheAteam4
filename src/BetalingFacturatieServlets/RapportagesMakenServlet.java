...
public class RapportagesMakenServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if(foutmelding == 2){
	        ...
	        pw3.println("Rapport Financi�le status:");
	        pw3.println("");
			...
			PrintWriter out = resp.getWriter();
		    out.println("<script type=\"text/javascript\">");
		    out.println("alert('Aanmaken gelukt, rapportages (BTW per artikel, BTW per transactie en Financi�le status) zijn aangemaakt!');");  
		    out.println("window.location = 'rapportagesaanmaken.jsp'");
		    out.println("</script>");
		    out.close();
		}
